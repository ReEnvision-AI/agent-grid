...
class OptimizedLlamaAttention(LlamaAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.config._attn_implementation != "eager" and self.config._attn_implementation is not None:
...
class OptimizedLlamaDecoderLayer(LlamaDecoderLayer):
    def __init__(self, config: LlamaConfig):
        ...
        # layer_idx only matters for KV caching, and we re-implement it in Agent Grid
