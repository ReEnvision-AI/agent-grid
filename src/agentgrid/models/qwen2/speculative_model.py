...
from agentgrid.models.qwen2.model import DistributedQwen2ForCausalLM


logger = get_logger(__name__)

class DistributedQwen2ForSepculativeGeneration(DistributedQwen2ForCausalLM, GenerationMixin):
    def __init__(self, config: DistributedQwen2Config, small_model: Qwen2ForCausalLM):
        DistributedQwen2ForCausalLM.__init__(self, config)
